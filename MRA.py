...
#The Credit For This Code Goes To RIAYED ISLAM RISHAN
...
\033[1;94mAuthor    \033[1;91m: \033[1;91mRIAYED ISLAM RISHAN

\033[1;94mMRA\033[1;91m: \033[1;91тЦТтЦУтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИ]99.9

\033[1;94mFacebook  \033[1;91m: \033[1;91mRIAYED ISLAM RISHAN
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Dev: RIAYED
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/riayed.islam.rishan.Official.0')
...
def login():
	...
	try:
		...
		jalan(' \033[1;92m     Notice:тШЮ \033[1;97mwash your hands every 1 hour' )
                ...
                jalan(' \033[1;92m    Warning:тШЮ \033[1;95mCloning Indian Id' )
...
def menu():
	...
	os.system("clear") #Dev: RIAYED ISLAM RISHAN
...
def pilih_super():
	...
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By baloch-hacker--тАвтЧИтАв---┬╗" #Dev: RIAYED_ISLAM_RISHAN
...
: \033[1;93m.RIAYED ISLAM RISHAN  MRA.... \033[1;93m :
